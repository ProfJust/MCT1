// sw04_X_und_Y_Motor_synchron ansteuern
//-----------------------------------------
// MCT1
...
void loop() {
  controller.rotate(  360, -180);
  // Test: Motoren drehen beide gleichzeitig, aber
  // unterschiedlich schnell und kommen gleichzeitig 
  // zum Stehen. 
  //Dabei haben sie unterschiedliche Winkel gedreht i.O.! 
  
  //Strom ausschalten, damit die Treiber nicht zu warm werden
  stepperX.disable();
  stepperY.disable();
  delay(300000);
}
